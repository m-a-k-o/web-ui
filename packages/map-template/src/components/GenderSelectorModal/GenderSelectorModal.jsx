                ...
                <div>
                    ...
                    <div dir="ltr" className="gender-modal">
                        <div className="gender-modal__content">
                            <div
                                className={`gender-modal__item ${gender === 'men' ? 'gender-modal__item__selected' : ''}`}
                                onClick={() => setGender('men')}>
                                <svg viewBox="0 0 320 320" fill="none" stroke="currentColor" strokeWidth="5"
                                    ...
                                    <path
                                        ...
                                        stroke="currentColor" />
                                    <path
                                        d="M128.432 166.812L121.432 197.544L160.001 223.819L198.57 197.544L191.569 166.812"
                                        stroke="currentColor"
                                    />
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="currentColor" />
                                    <path d="M252.031 219.319L219.125 59.2876" stroke="currentColor" />
